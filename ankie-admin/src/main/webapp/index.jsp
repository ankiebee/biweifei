...
<div class="content">
	...
	<div class="landing-logo">
    	<img class="replace-2x" src="images/logo.png" alt="img" width="100"></div>
    </div>
    ...
    <div class="navigation-icons">
    	<a href="<%=request.getContextPath() %>/home.do" class="nav-icon icon-red home-nav"></a>
        <a href="<%=request.getContextPath() %>/pic.do" class="nav-icon icon-blue about-nav"></a>
    ...
    <p class="landing-copyright copyright">COPYRIGHT 2018. ALL RIGHTS RESERVED</p>
