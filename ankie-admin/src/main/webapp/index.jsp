...
<body>
	...
	<div class="content">
		...
		<div class="landing-logo">
			<img class="replace-2x" src="images/logo.png" alt="img" width="100">
		</div>
	</div>
	...
	<div class="navigation-icons">
		<a href="<%=request.getContextPath() %>/home.do" class="nav-icon icon-red home-nav"></a> <a
			href="about.html" class="nav-icon icon-blue about-nav"></a> <a
			href="blog.html" class="nav-icon icon-magenta blog-nav"></a> <a
			href="folio.html" class="nav-icon icon-dblue folio-nav"></a> <a
			href="video.html" class="nav-icon icon-green video-nav"></a> <a
			href="contact.html" class="nav-icon icon-yellow mail-nav"></a>
	</div>

	<div class="small-navigation-icons">
		<a href="#" class="small-nav-icon facebook-nav"></a> <a href="#"
			class="small-nav-icon phone-nav"></a> <a href="#"
			class="small-nav-icon twitter-nav"></a>
		<div class="clear"></div>
	</div>

	<p class="landing-copyright copyright">COPYRIGHT 2013. ALL RIGHTS
		RESERVED</p>
